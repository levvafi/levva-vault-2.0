...
///@dev forge script script/vault/Arbitrum_DegenVault_USDC.s.sol:Arbitrum_DegenVault_USDC -vvvv --account testDeployer --rpc-url $ARB_RPC_URL --broadcast --verify --delay 7 --retries 15 --verifier etherscan --etherscan-api-key $ARBISCAN_KEY --verifier-url https://api.arbiscan.io/api
contract Arbitrum_DegenVault_USDC is LevvaVaultDeployer {
    ...
    function _getDeployConfig() internal view override returns (VaultConfig memory) {
        if (block.chainid == ARBITRUM) {
            ...
            VaultConfig memory config = VaultConfig({
                ...
                lpName: "Test Degen Levva Vault USDC",
                lpSymbol: "LVVA-USDC-DEGEN",
